...
def transfo(Pos,slide_z=0,D=0,rota=0,enlarge=10,enlarge_z=0.700758,do_periodic=True,mean=None):
...
if __name__ == "__main__":
    ...
    plotter.open_gif("helix_old.gif",fps=30,loop=1,subrectangles=True)

    Rota = np.linspace(0,1,60,endpoint=True)
    ...
    for rota in Rota:
        ...
        Pos_transfo,slide_z,mean = transfo(Pos,slide_z=0,D=D,rota=rota,do_periodic=False)
        x,y,z = Pos_transfo
